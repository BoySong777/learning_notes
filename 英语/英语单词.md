...
- **around**  adv  在四周（可做地点状语），漫无目的地，围绕；prep  围绕
  ...
  - round   adj  圆的，（大的，big；小的，small ；圆的，round；方的，square）；n 回合，阶段；  adv  围绕，旋转；  prep 围绕     

    round这个词是一个小词大用，它可以代表很多意思，本意做名词表示具体的圆和抽象的圆，比如回合，阶段，作动词表示做圆的动作，比如拥抱，四舍五入，发胖（让自己变圆）；做形容词表示一个闭环的，副词也是在到处，转圈。

    round one  第一回合；   another round 另一轮；  round face 圆脸； all-round player  全能选手   She put her arms round him. 抱住她

    这个词需要在后续的学习中不断积累意思。

  - roundabout   n  环形交叉路口； adj  （说话）绕圈子的，迂回的。

    ![image-20210929164653356](../TyporaResources/Image/image-20210929164653356.png)

  - surround  vt  围绕，包围；

    A bunch of beauties are surrounding him.

    be  surounded by    被。。。所包围。

    He was bonded and <font color='red'>beaten </font>by a bunch <font color='red'>of </font>bad <font color='red'>men</font>.

  - surrounding  adj  周围的，附近的；

- across  prep  穿过，从。。。的一边到另一边， 遍及；

  - cross  n 十字架（交叉的东西）；vi  交叉， 杂交； vt 渡过，使相交；
  - crossroads  n  十字路口
  - ring- road  n  十字路口
  - sideroad    n   人行道
  - routine     n   常规，惯例，adj 常规的

- enjoy   v  享受，喜爱，玩的开心（enjoy oneself），享有，拥有

  - joy  n  高兴， 欢乐；  v  感到高兴   vi 取悦，使高兴

    Fools have abundant joys.

- compass  n  罗盘，指南针； com--pass  来，通过吧！

  - pass   vt  传递，经过，通过；

- advance v 前进，提前，晋升；n 进步，上涨；adj  预先的
